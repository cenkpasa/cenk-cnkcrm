import { User, Appointment, Invoice, StockItem, Customer, Offer, OfferItem, SalesFunnelStage } from './types';
...
export const INTERVIEW_SEKTOR_OPTIONS = ['Otomotiv', 'Savunma Sanayi', 'Medikal', 'Havacılık', 'Kalıpçılık', 'Makine İmalat'];
export const REMINDER_OPTIONS = [
    { value: 'none', labelKey: 'noReminder' },
    { value: '15m', labelKey: 'reminder15m' },
    { value: '1h', labelKey: 'reminder1h' },
    { value: '1d', labelKey: 'reminder1d' },
];

export const SALES_FUNNEL_STAGES: Record<SalesFunnelStage, { titleKey: string, color: string }> = {
    potential: { titleKey: 'potential', color: 'bg-slate-400' },
    contacted: { titleKey: 'contacted', color: 'bg-sky-400' },
    proposal: { titleKey: 'proposal', color: 'bg-amber-400' },
    negotiation: { titleKey: 'negotiation', color: 'bg-purple-400' },
    won: { titleKey: 'won', color: 'bg-green-500' },
    lost: { titleKey: 'lost', color: 'bg-red-500' },
};
...
export const MESSAGES: Record<string, Record<string, string>> = {
    tr: {
        ...
        'proposal': 'Teklif Sunuldu',
        'negotiation': 'Müzakere',
        'won': 'Kazanıldı',
        'lost': 'Kaybedildi',
        'automationTaskCreated': '{customerName} için otomatik bir görev oluşturuldu.',
        ...
        'personnelSalesPerformance': 'Personel Satış Performansı',
        ...
        'appointmentReminder': '{title} başlıklı randevunuz {time} saatinde {customer} müşterisi ile başlayacak.',
        ...
        'disagreementDetails': 'Anlaşmazlık Detayları',
        ...
        'erpStockTab': 'Stok Durumu',
        'erpInvoicesTab': 'Faturalar',
        'erpTargetsTab': 'Satış Hedefleri',
        ...
        'syncSummaryBody': 'ERP sisteminden <strong class="text-cnk-accent-primary">{fetched}</strong> kayıt başarıyla işlendi.',
        ...
        'noTasksYet': 'Henüz görev eklenmemiş.',
        'taskUpdated': 'Görev güncellendi.',
        'tasksForCustomer': '{customerName} için Görevler',
        'activityTaskAdded': 'Yeni görev eklendi: {title}',
        'activityTaskDeleted': 'Görev silindi: {title}',
    ...
    en: {
        ...
        'won': 'Won',
        'lost': 'Lost',
        'automationTaskCreated': 'An automated task was created for {customerName}.',
        ...
        'personnelSalesPerformance': 'Personnel Sales Performance',
...
export const MOCK_USERS: User[] = [
  ...
  },
  {
    ...
    phone: '0555 123 4567',
    licensePlate: '06 CNK 01',
    vehicleModel: 'Fiat Egea',
    vehicleInitialKm: 15000,
    annualLeaveDays: 14,
  },
];
