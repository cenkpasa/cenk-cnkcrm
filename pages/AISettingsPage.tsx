...
const AISettingsPage = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8">
            <div>
                <h1 className="text-2xl font-bold">Yapay Zeka Asistanı Ayarları</h1>
                <p className="text-cnk-txt-muted-light mt-1">Asistanınızın nasıl çalışacağını buradan kontrol edin.</p>
            </div>
            
            <div className="bg-cnk-panel-light p-6 rounded-xl shadow-sm border border-cnk-border-light">
                <h2 className="text-lg font-bold mb-4">Genel Ayarlar</h2>
                <Switch label="Proaktif AI Ajanı'nı Aktif Et" checked={localSettings.isAgentActive} onChange={val => handleSwitchChange('isAgentActive', val)} />
            </div>

            <fieldset disabled={!localSettings.isAgentActive} className="space-y-6">
                <div className="bg-cnk-panel-light p-6 rounded-xl shadow-sm border border-cnk-border-light">
