...
import BarChart from '../components/dashboard/BarChart'; // Re-using for display
...
const ReportPage = () => {
    ...
    const { data, columns, title, summary } = useReportGenerator(filters);
            ...
            <div className="bg-cnk-panel-light p-4 rounded-xl shadow-sm border border-cnk-border-light">
                <div className="flex justify-between items-center mb-4">
                    ...
                    <div className="flex gap-2">
                        <Button onClick={() => exportToExcel(data, columns, title)} className="px-3 py-1 bg-green-600 text-white rounded-md text-sm">Excel'e Aktar</Button>
                        <Button onClick={() => exportToPdf(data, columns, title, title)} className="px-3 py-1 bg-red-600 text-white rounded-md text-sm">PDF'e Aktar</Button>
                    </div>
                </div>
