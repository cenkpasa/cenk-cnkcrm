...
// Fix: Corrected import path for ViewState type.
            ...
            <fieldset disabled={isReadOnly} className="border-2 border-cnk-border-light p-6 disabled:bg-slate-50">
                ...
                <div className="grid grid-cols-2 gap-6 text-sm">
                    <div className="border-2 border-cnk-txt-primary-light p-2 space-y-1">
                        ...
                        <select value={formState.customerId} onChange={handleCustomerChange} disabled={isReadOnly} className="w-full border border-cnk-border-light p-1 mb-2">
